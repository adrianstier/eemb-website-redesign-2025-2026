...
export default function NewsPageClient({ newsData }: NewsPageClientProps) {
  ...
  }, [newsData, searchTerm, selectedYear, selectedTopics])
      ...
      <section className="py-12 bg-warm-100 border-t border-warm-200">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-2">
            {years.map(year => {
              const count = newsData.filter(item =>
